...
try:
    release = pkg_resources.get_distribution('groundwork_web').version
except pkg_resources.DistributionNotFound:
    print('groundwork web must be installed to build the documentation.')
...
html_theme_options = {
    "contribute": True,
    "github_fork": "useblocks/groundwork-web",
...
#
# html_title = 'groundwork web v0.1'
...
htmlhelp_basename = 'groundwork webdocs'
...
latex_documents = [
    (master_doc, 'groundwork web.tex', 'groundwork web Documentation',
...
man_pages = [
    (master_doc, 'groundwork web', 'groundwork web Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'groundwork web', 'groundwork web Documentation',
     author, 'groundwork web', 'One line description of project.',
     'Miscellaneous'),
]
